...
/*        NeuralNetworkBtcPredictor nn = new NeuralNetworkBtcPredictor();
        nn.prepareData();*/
...
asd();
    ...
    public void asd() throws IOException {
        ...
        MultiLayerNetwork network = DeepLearningPredictor.buildLstmNetworks(iterator.inputColumns(), iterator.totalOutcomes());
        log.info("Training...");
        ...
        if (category.equals(PriceCategory.ALL)) {
            ...
            predictAllCategories(network, test, max, min);
        } else {
